      ...
      >
          ...
          {loading && notifications.length === 0 ? (
            ...
            notifications.map((notification) => (
              <li key={notification.id}>
                ...
                >
                  <span className="relative flex items-center justify-center w-10 h-10 overflow-hidden text-white rounded-full bg-brand-500 shrink-0">
                  ...
                  {notification.status === "unread" && (
                    <span className="absolute right-4 top-1/2 -translate-y-1/2 h-2 w-2 rounded-full bg-brand-500"></span>
                  )}
                </DropdownItem>
              </li>
            ))
        ...
        <div className="flex gap-2 mt-auto">
          <button
            ...
            className="flex-1 px-4 py-2 mt-3 text-sm font-medium text-center text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700"
          >
            Mark all read
          </button>
          <Link
            ...
            className="flex-1 px-4 py-2 mt-3 text-sm font-medium text-center text-white border border-transparent rounded-lg bg-brand-500 hover:bg-brand-600 dark:bg-brand-600 dark:hover:bg-brand-700"
          >
            View All
          </Link>
        </div>
