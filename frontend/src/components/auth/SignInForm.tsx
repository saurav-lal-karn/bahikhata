        ...
        <div className="p-8 rounded-[2rem] bg-white/5 border border-white/10 backdrop-blur-xl shadow-2xl">
          <div className="mb-8">
            <h1 className="mb-2 text-3xl font-black tracking-tight text-white">
              Welcome <span className="text-purple-400 italic">Back</span>
            </h1>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center gap-2">
                  <Checkbox checked={isChecked} onChange={setIsChecked} className="border-white/20 rounded-md" />
                  <span className="text-gray-400 font-medium">Keep me logged in</span>
                </div>
                <Link
                  href="/reset-password"
