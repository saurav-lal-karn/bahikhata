    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        className="h-12 rounded-2xl font-bold text-purple-600"
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <Select
                        ...
                        onChange={(val: string) =>
                            setFormData({ ...formData, wallet_id: val })
                        }
                        className="h-12 rounded-2xl"
                    />
                </div>
            ...
            <div className="flex items-center justify-end gap-4 border-t border-gray-50 pt-6 dark:border-gray-800">
                ...
                <Button
                    type="submit"
                    className="h-12 rounded-2xl bg-purple-600 px-12 font-bold text-white shadow-lg shadow-purple-500/20 hover:bg-purple-500"
                >
                    <Repeat className="mr-2 h-5 w-5" />{" "}
                    {initialData ? "Update Subscription" : "Start Tracking"}
                </Button>
            </div>
        </form>
    );
