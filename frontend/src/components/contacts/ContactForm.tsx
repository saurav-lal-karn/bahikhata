    ...
    useEffect(() => {
        if (contact) {
            setFormData({
                name: contact.name ?? "",
                type:
                    (contact.type as CreateContactRequest["type"]) ?? "VENDOR",
                email: contact.email ?? "",
                phone: contact.phone ?? "",
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <Select
                        ...
                        onChange={(value) =>
                            setFormData({
                                ...formData,
                                type: value as CreateContactRequest["type"],
                            })
                        }
            ...
            <div className="flex flex-wrap gap-3 pt-4">
                <Button
                    ...
                    className="rounded-2xl border-0 bg-gradient-to-r from-purple-600 to-indigo-600 px-6 py-3 font-bold text-white hover:from-purple-500 hover:to-indigo-500"
                >
                    {isSubmitting
                        ? "Saving…"
                        : isEdit
