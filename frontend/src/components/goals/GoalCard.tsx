...
export const GoalCard: React.FC<GoalCardProps> = ({ 
  ...
  return (
    <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-3xl p-6 shadow-sm hover:shadow-md transition-all group flex flex-col h-full border-b-4 border-b-transparent hover:border-b-current" style={{ borderBottomColor: barColor.replace('bg-', '') }}>
