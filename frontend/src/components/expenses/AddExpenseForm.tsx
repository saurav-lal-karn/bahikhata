...
export const AddExpenseForm: FC<AddExpenseFormProps> = ({
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
            ...
            <form onSubmit={handleSubmit} className="lg:col-span-12 xl:col-span-7 flex flex-col max-h-[85vh]">
                <div className="flex-1 overflow-y-auto pr-4 space-y-6 scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-gray-800 scrollbar-track-transparent">
