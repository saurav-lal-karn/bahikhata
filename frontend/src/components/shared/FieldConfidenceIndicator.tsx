...
export const FieldConfidenceIndicator: React.FC<FieldConfidenceIndicatorProps> = ({ 
  confidence, 
  fieldName,
  showLabel = true 
}) => {
  ...
  return (
    <div className="flex items-center gap-2 mt-1">
      <div 
        className={`flex items-center gap-1 px-2 py-0.5 rounded-full ${confidenceInfo.bgColor} ${confidenceInfo.color}`}
