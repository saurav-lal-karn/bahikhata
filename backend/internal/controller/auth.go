...
func (a *AuthController) Login(c *gin.Context) {
	...
	jwtTokens, err := a.svc.Login(c.Request.Context(), req.Email, req.Password)
	if err != nil {
...
func (a *AuthController) Register(c *gin.Context) {
	...
	requestUser := req.ToUser()
	user, err := a.svc.Register(c.Request.Context(), requestUser)
	if err != nil {
...
func (a *AuthController) Refresh(c *gin.Context) {
	...
	jwtTokens, err := a.svc.Refresh(c.Request.Context(), req.RefreshToken)
	if err != nil {
		helper.ErrorResponse(c, http.StatusUnauthorized, err.Error())
		return
	}
